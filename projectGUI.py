...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label1 = customtkinter.CTkLabel(self.sidebar_frame, text="YT Downloader", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label1.grid(row=0, column=0, padx=20, pady=(20, 10))
        self.logo_label2 = customtkinter.CTkLabel(self.sidebar_frame, text="Audio Format", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label2.grid(row=1, column=0, padx=20, pady=(0, 10))
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, command=self.preview, text="Preview")
        self.sidebar_button_1.grid(row=2, column=0, padx=20, pady=20)
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, command=self.download, text="Download")
        self.sidebar_button_2.grid(row=3, column=0, padx=20, pady=20)
